    ...
    <div className="flex flex-col gap-4 w-full">
      ...
      <div className="flex flex-col sm:flex-row gap-3">
        <a
          ...
          id="cta-app-store"
          className="flex-1 flex items-center justify-center gap-2.5 rounded-2xl bg-white text-black font-semibold py-3.5 px-5 text-sm hover:bg-zinc-100 active:scale-[0.98] transition-all shadow-lg shadow-black/20"
        >
        ...
        <a
          ...
          rel="noopener noreferrer"
          id="cta-play-store"
          className="flex-1 flex items-center justify-center gap-2.5 rounded-2xl border border-white/20 text-white font-semibold py-3.5 px-5 text-sm hover:bg-white/5 active:scale-[0.98] transition-all shadow-lg shadow-black/20"
        >
